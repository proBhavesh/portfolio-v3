            ...
            {projects.length > 0
                ? projects.map((list, i) => {
                      return (
                          <div
                              key={i}
                              className={`box w-full h-auto bg-dark-200 rounded-[5px] relative top-[50px] transition-all mb-[50px] mr-[5px] opacity-[.7] md:w-[250px] md:ml-0 hover:opacity-[1]`}
                          >
...
function StarRatings({ count = 1, size = 3, title = "star" }) {
    return (
        <>
            ...
            <small className="ml-2 text-white-200 font-extrabold">
                {count}
            </small>
